...
CREATE TABLE `car` (
  `idcar` int NOT NULL,
  `plateNb` int NOT NULL,
  `carType` varchar(45) NOT NULL,
  `carModel` varchar(45) NOT NULL,
  `carSymbol` char(1) NOT NULL,
  `idclient` int NOT NULL,
  PRIMARY KEY (`idcar`),
  KEY `idclient` (`idclient`),
  CONSTRAINT `car_ibfk_1` FOREIGN KEY (`idclient`) REFERENCES `client` (`idclient`)
...
INSERT INTO `car` VALUES (1,223344,'sedan','bmw x3','B',1);
